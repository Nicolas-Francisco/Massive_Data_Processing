...
public class CountCoStars {
    ...
    public static class CountCoStarsMapper extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void map(Object key, Text value, Context output)
            ...
            if(!rawWord[1].isEmpty()) {
                actors.set(rawWord[1]);
                output.write(actors, one);
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(CountCoStars.CountCoStarsMapper.class);
        job.setCombinerClass(CountCoStars.CountCoStarsReducer.class);
        job.setReducerClass(CountCoStars.CountCoStarsReducer.class);
