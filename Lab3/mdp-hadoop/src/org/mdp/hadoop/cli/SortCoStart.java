...
public class SortCoStart {
     ...
     *
     */
    public static class SortCoStartMapper extends
        ...
        public void map(Object key, Text value, Context output)
            ...
            output.write(new SortCoStart.DescendingIntWritable(Integer.parseInt(split[1])),new Text(split[0]));
        }
    }
     ...
     *
     */
    public static class SortCoStartReducer
            extends Reducer<SortCoStart.DescendingIntWritable, Text, Text, IntWritable> {
         ...
         */
        @Override
        public void reduce(SortCoStart.DescendingIntWritable key, Iterable<Text> values,
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: "+SortCoStart.class.getName()+" <in> <out>");
            System.exit(2);
        }
        ...
        job.setMapOutputKeyClass(SortCoStart.DescendingIntWritable.class);
        job.setMapOutputValueClass(Text.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(IntWritable.class);

        job.setMapperClass(SortCoStart.SortCoStartMapper.class); // no combiner this time!
        job.setReducerClass(SortCoStart.SortCoStartReducer.class);

        FileInputFormat.setInputPaths(job, new Path(inputLocation));
        FileOutputFormat.setOutputPath(job, new Path(outputLocation));

        job.setJarByClass(SortCoStart.class);
